  ...
  return (
    <div className="d-flex flex-wrap gap-2">
      ...
      <div
        ...
        className={`upload_btn ${fileEnter ? "border-primary border-4" : "border-secondary border-2"
          } bg-light d-flex flex-column align-items-center justify-content-center text-center rounded`}
      >
        <Image width={30} height={30} src={uploadImg} alt="" />
      ...
      {files.map((file, index) => (
        <div key={index} className="file_uploded_img">
          <Image
            src={file.url}
            alt={file.name}
            width={110}
